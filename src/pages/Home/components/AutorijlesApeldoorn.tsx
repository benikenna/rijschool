                    ...
                    leftContent={
                        <VStack align="start">
                            ...
                            <Text fontSize="14px" py={2}>
                                ...
                                oud bent. Op je 17e verjaardag kan je direct
                                afrijden. Tot je 18e verjaardag mag je samen met
                                je begeleider achter het stuur. Op je 18e
                                verjaardag mag je direct al volledig zelfstandig
                                auto rijden!
                            </Text>
                            <Text fontSize="14px" py={2}>
                                Je hebt bij ons de keuze om rijles te volgen in
                                een handgeschakelde en automaat lesauto. Houd er
                                wel rekening mee dat je met een automaat
                                rijbewijs, oftewel rijbewijs B met code 78, je
                                enkel in een automaat auto mag rijden.
                            </Text>
                            ...
                            <Text fontSize="14px" py={2}>
                                Wil je autorijlessen volgen en heb je al een
                                keuze gemaakt of je in een schakel of automaat
                                wilt rijden? Dan volgen de rijlessen. De
                                rijlessen zijn bij ons examengericht, wat dus
                                wilt zeggen dat we voornamelijk gaan rijden op
                                de examenroutes van het CBR. Zo zal het
                                praktijkexamen aanvoelen als een herhaling van
                                de lessen, waardoor het een stuk makkelijker
                                wordt om te slagen. Interesse? Vraag een gratis
                                proefles aan voor autorijles bij onze{" "}
                                <Link
                                    color={"orange"}
                                    onClick={() =>
