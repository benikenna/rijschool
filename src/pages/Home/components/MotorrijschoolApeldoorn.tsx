            ...
            <Box my={10}>
                <Section
                    leftContent={
                        <VStack align="start">
                            <Heading size="lg">
                                Motorrijschool {region ? region : "Apeldoorn"}
                            </Heading>
                            <Text fontSize="14px" py={2}>
                                Bij RijSchool Traffic Opleidingen bieden we ook
                                motorrijlessen aan. Ervaar de vrijheid van de
                                open weg en de opwinding van het motorrijden
                                onder begeleiding van onze ervaren instructeurs.
                                Onze motorrijschool in{" "}
                                {region ? region : "Apeldoorn"} staat klaar om
                                je te helpen jouw motorrijbewijs te behalen.
                            </Text>
                            ...
                            <Text fontSize="14px" py={2}>
                                Bij RijSchool Traffic streven we ernaar om jou
                                een geweldige ervaring te bieden op weg naar het
                                behalen van je motorrijbewijs. Ontdek de
                                spanning van motorrijden en schrijf je vandaag
                                nog in voor een proef{" "}
                                <Link
                                    color={"orange"}
                                    onClick={() =>
                                        navigate(`/motorrijles-apeldoorn`)
                                    }
                                >
